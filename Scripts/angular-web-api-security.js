                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="loginInputLogin" class="col-sm-3 control-label">Login</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="loginInputLogin" placeholder="User name" ng-model="vm.credentials.userName">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="loginInputPassword" class="col-sm-3 control-label">Password</label>
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="loginInputPassword" placeholder="Password" ng-model="vm.credentials.password">
                                </div>
                            </div>
